                    ...
                    <div class="card-body">
                        <div class="row gy-4 mb-4">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="" name="title"  value="{{old('title',$faq->title)}}"/>
                                @error('title')
                            ...
                            <div class="col-xl-12">
                                ...
                                <textarea rows="3" class="form-control" id="answer" placeholder="" name="answer">{{old('answer', $faq->response)}}</textarea>
                                @error('answer')
                                <span class="text-danger"><strong>{{$message}}</strong></span>
                                @enderror
                            </div>
