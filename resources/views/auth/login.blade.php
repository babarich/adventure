<x-guest-layout>
    ...
    <div class="flex h-screen">
        ...
        <div class="hidden lg:flex items-center justify-center flex-1  account-block"
             style="background-image: url('{{asset("assets/ynex/images/tiger.jpg")}}');
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Make your travel life easy </h1>
